...
import { listPatients, addPatient, addReport, deletePatient, setLabels, getPatient, setCondition, setAnalysis, addFeedback, } from "./db.js";
const app = express();
...
app.post("/api/v1/prescriptions/analyze", (req, res) => {
    ...
    const result = analyzePrescription(payload);
...
app.post("/doctor/patients/:id/condition", requireDoctor, (req, res) => {
    const { id } = req.params;
    ...
    try {
        ...
        const analysis = analyzePrescription(payload);
...
app.post("/doctor/patients/:id/check", requireDoctor, (req, res) => {
    const { id } = req.params;
