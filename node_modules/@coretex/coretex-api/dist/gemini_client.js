...
const REQUEST_TIMEOUT_MS = Number.isFinite(parsedTimeout) && parsedTimeout > 0 ? parsedTimeout : 20000;
function getApiKey() {
    ...
    if (key)
        return key;
    throw new Error("Missing Gemini API key. Set GEMINI_API_KEY in .env (GOOGLE_API_KEY and Gemini_API_KEY are also accepted).");
}
